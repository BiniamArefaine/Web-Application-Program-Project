    ...
    <ul class="followers">
        <li>
            ...
            <div class="friend-meta">
                <h4><a href="javascript:void(0)" title="">Kelly Bill</a></h4>
                <a href="javascript:void(0)" title="" class="underline">Add Friend</a>
            </div>
        </li>
        <li>
            <figure><img src="../../resources/images/resources/friend-avatar4.jpg" alt=""></figure>
            <div class="friend-meta">
                <h4><a href="javascript:void(0)" title="">Issabel</a></h4>
                <a href="javascript:void(0)" title="" class="underline">Add Friend</a>
            </div>
        </li>
        <li>
            ...
            <div class="friend-meta">
                <h4><a href="javascript:void(0)" title="">Andrew</a></h4>
                <a href="javascript:void(0)" title="" class="underline">Add Friend</a>
            </div>
        </li>
        <li>
            ...
            <div class="friend-meta">
                <h4><a href="javascript:void(0)" title="">Sophia</a></h4>
                <a href="javascript:void(0)" title="" class="underline">Add Friend</a>
            </div>
        </li>
        <li>
            ...
            <div class="friend-meta">
                <h4><a href="javascript:void(0)" title="">Allen</a></h4>
                <a href="javascript:void(0)" title="" class="underline">Add Friend</a>
            </div>
        </li>
    </ul>
