            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-right">
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Rotana</a></li>
...
<footer class="footer">
    © 2020 Rotana <span class="d-none d-sm-inline-block"><i class="mdi mdi-heart text-danger"></i></span>.
</footer>
